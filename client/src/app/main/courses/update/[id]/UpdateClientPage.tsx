  ...
  return (
    <Form className="grid grid-cols-2 gap-5">
      <Input
        ...
        type="number"
        min={0}
        defaultValue={courses.course[0]?.semesterNumber?.toString() || ""}
      />
      <Input
        isRequired
      ...
      <Input
        ...
        type="text"
        value={courses?.course[0]?.proffessorName}
      />
      <Input
        isRequired
        ...
        type="text"
        value={courses?.course[0]?.description}
      />
      <Input
        isRequired
        ...
        name="startDate"
        type="date"
        value={courses?.course[0]?.startDate}
      />
      <Input
        isRequired
